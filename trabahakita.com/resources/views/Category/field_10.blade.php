...
@section('content')
    <div class="container my-5" style="margin-top:10px">
        <h2>
                Posts related to "Web, Mobile & Software Development
                "  
        ...
        <div class="row">
            ...
            @else
            <h2>Sorry, There are no related posts for Hospitality, Tourism, and the Service Industry. <a href="/home">Go Back.</a></h2>
            @endif
