...
class PostController extends Controller
{
    ...
    public function updateme()
    {
        ...
        $posts->save();
        $post = Post::all();
        return redirect()->to('/post')->with(['post' => $post, 'success' => 'Post Updated']);
    }
    ...
    public function Activate()
    {
        ...
        return redirect()->to('/post')->with('success', 'Post Activated');
    }
    ...
    public function Deactivate()
    {
        ...
        return redirect()->to('/post')->with('success', 'Post Deactivated');
    }
}
